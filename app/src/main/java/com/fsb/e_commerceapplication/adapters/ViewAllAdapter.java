...
import com.fsb.e_commerceapplication.activities.DetailedActivity;
...
public class ViewAllAdapter extends RecyclerView.Adapter<ViewAllAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.viewallproduct.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout viewallproduct;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.view_img);
            viewallproduct = itemView.findViewById(R.id.viewallproduct);
