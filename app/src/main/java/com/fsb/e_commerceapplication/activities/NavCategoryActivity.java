...
import com.fsb.e_commerceapplication.adapters.NavCategoryDetailedAdapter;
import com.fsb.e_commerceapplication.models.HomeCategory;
import com.fsb.e_commerceapplication.models.NavCategoryDetailedModel;
...
public class NavCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(type != null && type.equalsIgnoreCase("food")) {
            db.collection("NavCategoryDetailed").whereEqualTo("type", "food").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                @Override
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    for (DocumentSnapshot documentSnapshot : task.getResult().getDocuments()) {
                        NavCategoryDetailedModel navCategoryDetailedModel = documentSnapshot.toObject(NavCategoryDetailedModel.class);
